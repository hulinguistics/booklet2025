...
この類型では、言われた事柄のレベルでは**実際に**公理が逸脱されているのに対して、推意された事柄のレベルでは公理は遵守されている、少なくとも全般的な協調の原理は遵守されていると考えることになります。[^1]
...
すなわち、グライスの類型に従う限りでは、侵害の場合には公理の逸脱は**見かけ上**のものに過ぎず、公理は言われた事柄のレベルでも再び遵守されることになると考えられるのに対して、衝突や無視の場合には言われた事柄のレベルで公理が**実際に**逸脱されており、推意された事柄のレベルでのみ公理が遵守されるのだとして整理することができそうです。[^1]
