...
| **鼻音** |m  |mʲ   |n    |         |nʲ   |>    |※文献によっては ʃ, ʒ ではなく ʂ, ʐ と転写される| |(ŋ)|(ŋʲ) |
| **流音** |   |     |l r  |(lʲ rʲ)  |     |^    |^        | |   |     |
|**接近音**|   |     |     |         |     |^    |^        |j|w  |     |
...
|^|**c**|^|**dz**|c, dz /t͡s, d͡z/ は第2次口蓋化と呼ばれる歴史的音変化によって k, g から生じた音|
|^|**cz**|^|**ż**|cz, ż /t͡ʃ, d͡ʒ/ は第1次口蓋化現象によって k, g から生じた音|
|**ch**|**chi-**|**h**|**hi-**| |
|^|**sz**|^|**ż**| |
|**m**|**mi-**|**n**|**ń, ni-**| |
|**ł**|**l**|**r**|**rz**| |
...
| |>|>|>|単数|>|複数|
|:----:|:----:|:----:|:----:|:----:|:----:|:----:|
| |男性活動体|男性不活動体|中性|女性|男性人間|男性非人間|
|**主呼**|>|dobry|dobre|dobra|dobrzy|dobre|
...
|>|不定形 być|現在|過去|未来|命令法|仮定法|
|:----:|:----:|:----|:----|:----|:----|:----|
|**単数**|1人称|jestem|byłem|będę|-|byłbym|
|^|2人称|jesteś|byłeś|będziesz|bądź|byłbyś|
|^|3人称|jest|był|będzie|bądźmy|byłby|
|**複数**|1人称|jesteśmy|byliśmy|będziemy|bądźcie|bylibyśmy|
|^|2人称|jesteście|byliście|będziecie|-|bylibyście|
|^|3人称|są|byli|będą|-|byliby|

|>|不定形 pisać|現在|過去|未来|命令法|仮定法|
|:----:|:----:|:----|:----|:----|:----|:----|
|**単数**|1人称|piszę|pisałem|będę pisał|-|pisałbym|
|^|2人称|piszesz|pisałeś|będziesz pisał|pisz|pisałbyś|
|^|3人称|pisze|pisał|będzie pisał|-|pisałby|
|**複数**|1人称|piszemy|pisaliśmy|będziemy pisali|piszmy|pisalibyśmy|
|^|2人称|piszecie|pisaliście|będziecie pisali|piszcie|pisalibyście|
|^|3人称|piszą|pisali|będą pisali|-|pisaliby|

## 統語論

### 語順はある程度自由

ポーランド語には名詞類の格変化や動詞の人称変化があるため，文の主語，述語，目的語などは語形を見れば（聞けば）判別できます．そういうわけで，英語のような決まった語順というものはポーランド語にはありません．主題を文の始めに置いて，新たな情報や重要な情報を文の後ろに置くという点で日本語と似ています．
